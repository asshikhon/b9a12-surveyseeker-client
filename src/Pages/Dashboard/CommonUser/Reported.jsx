  ...
  return (
    <div className="mt-12 md:mt-20 lg:mt-24">
      ...
      <div className="my-4 bg-[#333333] rounded-xl py-4 text-center text-lg text-orange-500 font-bold">
        <h2 className="mr-2">Here Is Reported Surveys Lists Of {user?.displayName} </h2>
      </div>
          ...
          {surveys.map((survey, index) => (
            ...
            >
              <div className="card-body items-center text-center">
                ...
                <p className="text-lg py-5 text-red-500">FeedBack Message : {survey?.feedBack}</p>
                <h3 className="text-[#5C4033] text-lg ">
                  Total Vote Count: ({survey?.totalVote || 0})
                </h3>
              </div>
